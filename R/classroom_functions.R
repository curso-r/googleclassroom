...
#' @importFrom googleAuthR gar_api_generator
#' @export
invitations.list <- function(courseId = NULL, userId = NULL, pageToken = NULL, pageSize = NULL) {
...
#' Deletes a course.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not permitted to delete therequested course or for access errors.* `NOT_FOUND` if no course exists with the requested ID.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' Returns a list of courses that the requesting user is permitted to view,restricted to those that match the request. Returned courses are ordered bycreation time, with the most recently created coming first.This method returns the following error codes:* `PERMISSION_DENIED` for access errors.* `INVALID_ARGUMENT` if the query argument is malformed.* `NOT_FOUND` if any users specified in the query arguments do not exist.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.list <- function(studentId = NULL, pageToken = NULL, pageSize = NULL, teacherId = NULL,
    courseStates = NULL) {
...
#' Creates a course.The user specified in `ownerId` is the owner of the created courseand added as a teacher.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not permitted to createcourses or for access errors.* `NOT_FOUND` if the primary teacher is not a valid user.* `FAILED_PRECONDITION` if the course owner's account is disabled or forthe following request errors:    * UserGroupsMembershipLimitReached* `ALREADY_EXISTS` if an alias was specified in the `id` andalready exists.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' Returns a course.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not permitted to access therequested course or for access errors.* `NOT_FOUND` if no course exists with the requested ID.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' Updates a course.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not permitted to modify therequested course or for access errors.* `NOT_FOUND` if no course exists with the requested ID.* `FAILED_PRECONDITION` for the following request errors:    * CourseNotModifiable
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' Creates a topic.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not permitted to access therequested course, create a topic in the requested course,or for access errors.* `INVALID_ARGUMENT` if the request is malformed.* `NOT_FOUND` if the requested course does not exist.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' @export
courses.topics.create <- function(Topic, courseId) {
...
#' Deletes a topic.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not allowed to delete therequested topic or for access errors.* `FAILED_PRECONDITION` if the requested topic has already beendeleted.* `NOT_FOUND` if no course or topic exists with the requested ID.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.topics.delete <- function(courseId, id) {
...
#' Updates one or more fields of a topic.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting developer project did not createthe corresponding topic or for access errors.* `INVALID_ARGUMENT` if the request is malformed.* `NOT_FOUND` if the requested course or topic does not exist
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' @family Topic functions
#' @export
courses.topics.patch <- function(Topic, courseId, id, updateMask = NULL) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/topics/%s", courseId,
        id)
...
#' Returns a topic.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not permitted to access therequested course or topic, or for access errors.* `INVALID_ARGUMENT` if the request is malformed.* `NOT_FOUND` if the requested course or topic does not exist.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.topics.get <- function(courseId, id) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/topics/%s", courseId,
        id)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.topics.list <- function(courseId, pageToken = NULL, pageSize = NULL) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/topics", courseId)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.aliases.delete <- function(courseId, alias) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.aliases.list <- function(courseId, pageToken = NULL, pageSize = NULL) {
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param CourseAlias The \link{CourseAlias} object to pass to this method
#' @param courseId Identifier of the course to alias
#' @importFrom googleAuthR gar_api_generator
#' @family CourseAlias functions
#' @export
courses.aliases.create <- function(CourseAlias, courseId) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/aliases", courseId)
...
#' Deletes a course work.This request must be made by the Developer Console project of the[OAuth client ID](https://support.google.com/cloud/answer/6158849) used tocreate the corresponding course work item.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting developer project did not createthe corresponding course work, if the requesting user is not permittedto delete the requested course or for access errors.* `FAILED_PRECONDITION` if the requested course work has already beendeleted.* `NOT_FOUND` if no course exists with the requested ID.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.courseWork.delete <- function(courseId, id) {
...
#' Returns a list of course work that the requester is permitted to view.Course students may only view `PUBLISHED` course work. Course teachersand domain administrators may view all course work.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not permitted to accessthe requested course or for access errors.* `INVALID_ARGUMENT` if the request is malformed.* `NOT_FOUND` if the requested course does not exist.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.courseWork.list <- function(courseId, orderBy = NULL, pageToken = NULL, pageSize = NULL,
...
#' Creates course work.The resulting course work (and corresponding student submissions) areassociated with the Developer Console project of the[OAuth client ID](https://support.google.com/cloud/answer/6158849) used tomake the request. Classroom API requests to modify course work and studentsubmissions must be made with an OAuth client ID from the associatedDeveloper Console project.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not permitted to access therequested course, create course work in the requested course, share aDrive attachment, or for access errors.* `INVALID_ARGUMENT` if the request is malformed.* `NOT_FOUND` if the requested course does not exist.* `FAILED_PRECONDITION` for the following request error:    * AttachmentNotVisible
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param CourseWork The \link{CourseWork} object to pass to this method
#' @param courseId Identifier of the course
#' @importFrom googleAuthR gar_api_generator
#' @family CourseWork functions
#' @export
courses.courseWork.create <- function(CourseWork, courseId) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/courseWork", courseId)
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param ModifyCourseWorkAssigneesRequest The \link{ModifyCourseWorkAssigneesRequest} object to pass to this method
#' @param courseId Identifier of the course
#' @param id Identifier of the coursework
#' @importFrom googleAuthR gar_api_generator
#' @family ModifyCourseWorkAssigneesRequest functions
#' @export
courses.courseWork.modifyAssignees <- function(ModifyCourseWorkAssigneesRequest,
    courseId, id) {
...
#' Updates one or more fields of a course work.See google.classroom.v1.CourseWork for detailsof which fields may be updated and who may change them.This request must be made by the Developer Console project of the[OAuth client ID](https://support.google.com/cloud/answer/6158849) used tocreate the corresponding course work item.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting developer project did not createthe corresponding course work, if the user is not permitted to make therequested modification to the student submission, or foraccess errors.* `INVALID_ARGUMENT` if the request is malformed.* `FAILED_PRECONDITION` if the requested course work has already beendeleted.* `NOT_FOUND` if the requested course, course work, or student submissiondoes not exist.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' @family CourseWork functions
#' @export
courses.courseWork.patch <- function(CourseWork, courseId, id, updateMask = NULL) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/courseWork/%s",
        courseId, id)
...
#' Returns course work.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not permitted to access therequested course or course work, or for access errors.* `INVALID_ARGUMENT` if the request is malformed.* `NOT_FOUND` if the requested course or course work does not exist.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.courseWork.get <- function(courseId, id) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/courseWork/%s",
        courseId, id)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.courseWork.studentSubmissions.get <- function(courseId, courseWorkId, id) {
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param StudentSubmission The \link{StudentSubmission} object to pass to this method
#' @param courseId Identifier of the course
#' @param courseWorkId Identifier of the course work
#' @param id Identifier of the student submission
...
#' @export
courses.courseWork.studentSubmissions.patch <- function(StudentSubmission, courseId,
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param ReturnStudentSubmissionRequest The \link{ReturnStudentSubmissionRequest} object to pass to this method
#' @param courseId Identifier of the course
#' @param courseWorkId Identifier of the course work
#' @param id Identifier of the student submission
#' @importFrom googleAuthR gar_api_generator
...
#' @export
courses.courseWork.studentSubmissions.return <- function(ReturnStudentSubmissionRequest,
    courseId, courseWorkId, id) {
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param ReclaimStudentSubmissionRequest The \link{ReclaimStudentSubmissionRequest} object to pass to this method
#' @param courseId Identifier of the course
#' @param courseWorkId Identifier of the course work
#' @param id Identifier of the student submission
#' @importFrom googleAuthR gar_api_generator
...
#' @export
courses.courseWork.studentSubmissions.reclaim <- function(ReclaimStudentSubmissionRequest,
    courseId, courseWorkId, id) {
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param TurnInStudentSubmissionRequest The \link{TurnInStudentSubmissionRequest} object to pass to this method
#' @param courseId Identifier of the course
#' @param courseWorkId Identifier of the course work
#' @param id Identifier of the student submission
#' @importFrom googleAuthR gar_api_generator
...
#' @export
courses.courseWork.studentSubmissions.turnIn <- function(TurnInStudentSubmissionRequest,
    courseId, courseWorkId, id) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.courseWork.studentSubmissions.list <- function(courseId, courseWorkId, userId = NULL,
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param ModifyAttachmentsRequest The \link{ModifyAttachmentsRequest} object to pass to this method
#' @param courseId Identifier of the course
#' @param courseWorkId Identifier of the course work
#' @param id Identifier of the student submission
#' @importFrom googleAuthR gar_api_generator
...
#' @export
courses.courseWork.studentSubmissions.modifyAttachments <- function(ModifyAttachmentsRequest,
    courseId, courseWorkId, id) {
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param Teacher The \link{Teacher} object to pass to this method
#' @param courseId Identifier of the course
#' @importFrom googleAuthR gar_api_generator
#' @family Teacher functions
#' @export
courses.teachers.create <- function(Teacher, courseId) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.teachers.delete <- function(courseId, userId) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.teachers.get <- function(courseId, userId) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/teachers/%s",
        courseId, userId)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.teachers.list <- function(courseId, pageToken = NULL, pageSize = NULL) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/teachers", courseId)
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param Announcement The \link{Announcement} object to pass to this method
#' @param courseId Identifier of the course
#' @importFrom googleAuthR gar_api_generator
#' @family Announcement functions
#' @export
courses.announcements.create <- function(Announcement, courseId) {
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param ModifyAnnouncementAssigneesRequest The \link{ModifyAnnouncementAssigneesRequest} object to pass to this method
#' @param courseId Identifier of the course
#' @param id Identifier of the announcement
#' @importFrom googleAuthR gar_api_generator
#' @family ModifyAnnouncementAssigneesRequest functions
#' @export
courses.announcements.modifyAssignees <- function(ModifyAnnouncementAssigneesRequest,
    courseId, id) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.announcements.get <- function(courseId, id) {
...
#' @family Announcement functions
#' @export
courses.announcements.patch <- function(Announcement, courseId, id, updateMask = NULL) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/announcements/%s",
        courseId, id)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.announcements.delete <- function(courseId, id) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/announcements/%s",
        courseId, id)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.announcements.list <- function(courseId, announcementStates = NULL, orderBy = NULL,
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.students.delete <- function(courseId, userId) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.students.get <- function(courseId, userId) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/students/%s",
        courseId, userId)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
courses.students.list <- function(courseId, pageToken = NULL, pageSize = NULL) {
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param Student The \link{Student} object to pass to this method
...
#' @export
courses.students.create <- function(Student, courseId, enrollmentCode = NULL) {
    url <- sprintf("https://classroom.googleapis.com/v1/courses/%s/students", courseId)
...
#' Returns a user profile.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not permitted to accessthis user profile, if no profile exists with the requested ID, or foraccess errors.
#'
#' Autogenerated via \code{\link[googleAuthR]{gar_create_api_skeleton}}
#'
#' @seealso \href{https://developers.google.com/classroom/}{Google Documentation}
...
#' @importFrom googleAuthR gar_api_generator
#' @export
userProfiles.guardianInvitations.list <- function(studentId, pageToken = NULL, invitedEmailAddress = NULL,
...
#' @importFrom googleAuthR gar_api_generator
#' @export
userProfiles.guardianInvitations.get <- function(studentId, invitationId) {
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param GuardianInvitation The \link{GuardianInvitation} object to pass to this method
...
#' @export
userProfiles.guardianInvitations.patch <- function(GuardianInvitation, studentId,
...
#' @family GuardianInvitation functions
#' @export
userProfiles.guardianInvitations.create <- function(GuardianInvitation, studentId) {
    url <- sprintf("https://classroom.googleapis.com/v1/userProfiles/%s/guardianInvitations",
        studentId)
...
#' @importFrom googleAuthR gar_api_generator
#' @export
userProfiles.guardians.list <- function(studentId, pageToken = NULL, invitedEmailAddress = NULL,
    pageSize = NULL) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
userProfiles.guardians.get <- function(studentId, guardianId) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
userProfiles.guardians.delete <- function(studentId, guardianId) {
    url <- sprintf("https://classroom.googleapis.com/v1/userProfiles/%s/guardians/%s",
        studentId, guardianId)
...
#' See \code{\link[googleAuthR]{gar_auth}} for details.
#'
#' @param Registration The \link{Registration} object to pass to this method
#' #' @importFrom googleAuthR gar_api_generator
#' @family Registration functions
#' @export
registrations.create <- function(Registration) {
...
#' @importFrom googleAuthR gar_api_generator
#' @export
registrations.delete <- function(registrationId) {
